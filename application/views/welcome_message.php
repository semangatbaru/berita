                                ...
                                <div class="swiper-container oflow-visible" data-slide-effect="slide" data-autoheight="false" 
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="bg-white">
                                                <img src="<?php echo base_url('assets/') ?>images/hot_news_1_300x150.jpg" alt="">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="bg-white">
                                                <img src="<?php echo base_url('assets/') ?>images/hot_news_2_300x150.jpg" alt="">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="bg-white">
                                                <img src="<?php echo base_url('assets/') ?>images/hot_news_3_300x150.jpg" alt="">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="pos-relative">
                                                    ...
                                                    <img src="<?php echo base_url('assets/') ?>images/trending_2_400X250.jpg" alt="">
                                                </div><!-- pos-relative -->
                                            </div><!-- swiper-slide -->
                                            ...
                                            <div class="swiper-slide">
                                                <div class="pos-relative">
                                                    <a class="abs-center circle-50 bg-tp-5 text-center" href="#">
                                                        <i class="lh-50 font-12 ion-play"></i></a>
                                                    <img src="<?php echo base_url('assets/') ?>images/trending_3_400X250.jpg" alt="">
                                                </div><!-- pos-relative -->
                                            </div><!-- swiper-slide -->
                                            ...
                                            <div class="swiper-slide">
                                                <div class="pos-relative">
                                                    <a class="abs-center circle-50 bg-tp-5 text-center" href="#">
                                                        <i class="lh-50 font-12 ion-play"></i></a>
                                                    <img src="<?php echo base_url('assets/') ?>images/latest_articles_8_400x250.jpg" alt="">
                                                </div><!-- pos-relative -->
                                            </div><!-- swiper-slide -->
                                            ...
                                            <div class="swiper-slide">
                                                <div class="pos-relative">
                                                    <a class="abs-center circle-50 bg-tp-5 text-center" href="#">
                                                        <i class="lh-50 font-12 ion-play"></i></a>
                                                    <img src="<?php echo base_url('assets/') ?>images/latest_articles_3_400x250.jpg" alt="">
                                                </div><!-- pos-relative -->
                                            </div><!-- swiper-slide -->
                            ...
                            <div class="mx-w-md-400x mlr-md-auto">
                                ...
                                <div class="mb-50">
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            <img src="<?php echo base_url('assets/') ?>images/top_1_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            <img src="<?php echo base_url('assets/') ?>images/top_2_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                            <h5 class="pt-5"><a href="#"><b>I Got off Addrall and Xanax Using Psilocybon</b></a></h5>
                                        </div><!-- s-left -->
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            <img src="<?php echo base_url('assets/') ?>images/top_3_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                            <h5 class="pt-5"><a href="#"><b>I Got off Addrall and Xanax Using Psilocybon</b></a></h5>
                                        </div><!-- s-left -->
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            <img src="<?php echo base_url('assets/') ?>images/top_4_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                            <h5 class="pt-5"><a href="#"><b>I Got off Addrall and Xanax Using Psilocybon</b></a></h5>
                                        </div><!-- s-left -->
                                ...
                                <a class="mb-50 pos-relative dplay-block" href="#">
                                    ...
                                    <img src="<?php echo base_url('assets/') ?>images/sidebar_2_400X600.jpg" alt="">
                                ...
                                <div class="mb-50">
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            ...
                                            <img src="<?php echo base_url('assets/') ?>images/top_5_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                            <h5 class="pt-5"><a href="#"><b>I Got off Addrall and Xanax Using Psilocybon</b></a></h5>
                                        </div><!-- s-left -->
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            <a class="v-icn" href="#"><i class="ion-play"></i></a>
                                            <img src="<?php echo base_url('assets/') ?>images/top_6_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                            <h5 class="pt-5"><a href="#"><b>I Got off Addrall and Xanax Using Psilocybon</b></a></h5>
                                        </div><!-- s-left -->
                                    ...
                                    <div class="sided-80x mb-20">
                                        <div class="s-left">
                                            <a class="v-icn" href="#"><i class="ion-play"></i></a>
                                            <img src="<?php echo base_url('assets/') ?>images/top_7_120x120.jpg" alt="">
                                        </div><!-- s-left -->
                                        <div class="s-right">
                                            <h5 class="pt-5"><a href="#"><b>I Got off Addrall and Xanax Using Psilocybon</b></a></h5>
                                        </div><!-- s-left -->
                                ...
                                <a class="mb-50 pos-relative dplay-block" href="#">
                                    ...
                                    <img src="<?php echo base_url('assets/') ?>images/sidebar_1_400X300.jpg" alt="">
                                    <div class="abs-tblr z-10 bg-layer-4">
